...
def make_target_diff_samples(n=10**7, nr=3, diff_type=1, diff=(0x40080000, 0x04000000), return_keys=0):
...
def make_dataset_with_group_size(n, nr, diff=(0x40080000, 0x04000000), group_size=2):
...
# x, y = make_dataset(n=10**(7), nr=16)
# np.save('training_dataset.npy', x)
