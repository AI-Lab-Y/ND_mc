...
def make_resnet(group_size=2, num_blocks=4, num_filters=32, num_outputs=1, d1=64, d2=64, word_size=32, ks=3, depth=5, reg_param=0.001, final_activation='sigmoid'):
...
def train_joint_key_distinguisher(num_epochs, X, Y, X_eval, Y_eval, num_rounds=7, group_size=2, depth=1):
    ...
    # save model
    net.save('./saved_model/new_model/jk_' + str(num_rounds) + '_' + str(group_size) + '_mc_distinguisher.h5')
...
def train_random_key_distinguisher(num_epochs, X, Y, X_eval, Y_eval, num_rounds=7, group_size=2, depth=1):
    ...
    # save model
    net.save('./saved_model/new_model/rk_' + str(num_rounds) + '_' + str(group_size) + '_mc_distinguisher.h5')
